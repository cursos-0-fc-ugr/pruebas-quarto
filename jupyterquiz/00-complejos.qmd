...
Resuelve los siguientes problemas para poner a prueba tus conocimientos.

```{python}
#| echo: false
from jupyterquiz_local import display_quiz
import json

# Forzamos la lectura en UTF-8 para evitar los símbolos raros
with open("preguntas.json", "r", encoding="utf-8") as f:
    datos = json.load(f)

display_quiz(datos,colors='fdsp',border_radius=5,question_alignment="left",shuffle_answers=True,shuffle_questions=True)
```
